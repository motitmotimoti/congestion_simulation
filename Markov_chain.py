...
#ディレクトリの変更をするように！！
df_state = pd.read_csv('result/high/2019-07-12/result_list_state_3.csv', index_col=0)
...
#ディレクトリの変更を忘れずに！！！
df_info = pd.read_csv('result/high/2019-07-12/result_info_3.csv',index_col=0)
...
for x in range(0,length-1):
    ...
    #ディレクトリは生成し、変更すること
    np.save(f'matrix/high/2019-07-12/matrix_3/result_matrix_{x+1}',result_x)
    print(f'result_{x+1}:\n{result_x}')
    print(f'mat_{x+1}:\n{mat_x}')
...
#ディレクトリの変更
markov.to_csv(f'markov/high/2019-07-12/markov_chain_3.csv')
